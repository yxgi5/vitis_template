...
input  [1:0] pattern_V;
 ...
 reg    ap_rst_n_inv;
reg   [119:0] s_axis_video_V_data_V_0_data_out;
...
reg   [119:0] s_axis_video_V_data_V_0_payload_A;
reg   [119:0] s_axis_video_V_data_V_0_payload_B;
...
reg   [39:0] m_axis_video_V_data_V_1_data_out;
...
reg   [39:0] m_axis_video_V_data_V_1_payload_A;
reg   [39:0] m_axis_video_V_data_V_1_payload_B;
...
wire   [4:0] m_axis_video_V_keep_V_1_data_out;
...
wire   [4:0] m_axis_video_V_strb_V_1_data_out;
...
wire   [0:0] tmp_13_fu_411_p2;
reg    m_axis_video_TDATA_blk_n;
wire    ap_CS_fsm_state4;
wire    ap_CS_fsm_state1;
wire   [0:0] sel_tmp_fu_247_p2;
reg   [0:0] sel_tmp_reg_675;
wire   [0:0] sel_tmp7_fu_253_p2;
reg   [0:0] sel_tmp7_reg_681;
wire   [0:0] sel_tmp4_fu_259_p2;
reg   [0:0] sel_tmp4_reg_687;
wire   [0:0] sel_tmp3_fu_265_p2;
reg   [0:0] sel_tmp3_reg_693;
wire   [30:0] j_1_fu_280_p2;
reg   [30:0] j_1_reg_702;
wire    ap_CS_fsm_state2;
reg    ap_block_state2;
wire   [0:0] sel_tmp1_fu_296_p2;
reg   [0:0] sel_tmp1_reg_707;
wire   [0:0] tmp_1_fu_275_p2;
wire   [0:0] sel_tmp5_fu_301_p2;
reg   [0:0] sel_tmp5_reg_712;
wire   [0:0] sel_tmp8_fu_306_p2;
reg   [0:0] sel_tmp8_reg_717;
wire   [0:0] sel_tmp2_fu_311_p2;
reg   [0:0] sel_tmp2_reg_722;
wire   [0:0] sel_tmp6_fu_316_p2;
reg   [0:0] sel_tmp6_reg_727;
wire   [0:0] sel_tmp9_fu_321_p2;
reg   [0:0] sel_tmp9_reg_732;
wire   [0:0] sel_tmp10_fu_326_p2;
reg   [0:0] sel_tmp10_reg_737;
wire   [0:0] sel_tmp11_fu_331_p2;
reg   [0:0] sel_tmp11_reg_742;
wire   [31:0] tmp_12_fu_403_p3;
reg   [31:0] tmp_12_reg_747;
reg    ap_block_state3;
reg    ap_block_state3_io;
wire   [39:0] video_o_data_V_fu_638_p3;
wire   [31:0] i_1_fu_646_p2;
reg   [31:0] i_1_reg_770;
reg   [30:0] j_reg_225;
reg   [31:0] i_reg_236;
reg   [39:0] p_Val2_s_fu_156;
wire   [31:0] j_cast_fu_271_p1;
wire   [0:0] tmp_2_fu_286_p1;
wire   [0:0] tmp_3_fu_290_p2;
wire   [31:0] hsize_in_op_op_fu_343_p2;
wire   [31:0] p_neg_fu_356_p2;
wire   [29:0] p_lshr_fu_361_p4;
wire   [0:0] tmp_8_fu_348_p3;
wire   [29:0] p_neg_t_fu_371_p2;
wire   [29:0] tmp_9_fu_377_p4;
wire   [0:0] tmp_4_fu_336_p3;
wire   [29:0] tmp_10_fu_387_p3;
wire   [29:0] tmp_11_fu_395_p3;
wire   [19:0] tmp_5_fu_433_p4;
wire   [19:0] tmp_6_fu_443_p4;
wire   [9:0] p_Result_2_fu_485_p4;
wire   [9:0] p_Result_1_fu_475_p4;
wire   [9:0] p_Result_s_7_fu_465_p4;
wire   [9:0] tmp_14_fu_461_p1;
wire   [9:0] p_Result_5_fu_507_p4;
wire   [19:0] tmp_7_fu_517_p4;
wire   [9:0] p_Result_6_fu_567_p4;
wire   [9:0] p_Result_3_fu_557_p4;
wire   [9:0] p_Result_9_fu_547_p4;
wire   [9:0] p_Result_7_fu_537_p4;
wire   [39:0] p_Result_s_fu_453_p3;
wire   [39:0] p_Result_4_fu_495_p5;
wire   [39:0] video_o_data_V_4_fu_589_p3;
wire   [39:0] p_Result_8_fu_527_p4;
wire   [39:0] video_o_data_V_5_fu_596_p3;
wire   [39:0] p_Result_10_fu_577_p5;
wire   [39:0] video_o_data_V_6_fu_603_p3;
wire   [39:0] video_o_data_V_7_fu_610_p3;
wire   [39:0] video_o_data_V_8_fu_617_p3;
wire   [39:0] video_o_data_V_9_fu_624_p3;
wire   [39:0] video_o_data_V_11_fu_631_p3;
reg   [3:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if ((~((1'b1 == ap_block_state3_io) | ((tmp_13_fu_411_p2 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0))) & (tmp_13_fu_411_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        i_1_reg_770 <= i_1_fu_646_p2;
        p_Val2_s_fu_156 <= video_o_data_V_fu_638_p3;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((m_axis_video_V_dest_V_1_ack_in == 1'b0) | (m_axis_video_V_id_V_1_ack_in == 1'b0) | (m_axis_video_V_last_V_1_ack_in == 1'b0) | (m_axis_video_V_user_V_1_ack_in == 1'b0) | (m_axis_video_V_strb_V_1_ack_in == 1'b0) | (m_axis_video_V_keep_V_1_ack_in == 1'b0) | (m_axis_video_V_data_V_1_ack_in == 1'b0)) & (1'b1 == ap_CS_fsm_state2))) begin
        j_1_reg_702 <= j_1_fu_280_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_data_V_1_load_A == 1'b1)) begin
        m_axis_video_V_data_V_1_payload_A <= video_o_data_V_fu_638_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_data_V_1_load_B == 1'b1)) begin
        m_axis_video_V_data_V_1_payload_B <= video_o_data_V_fu_638_p3;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((m_axis_video_V_dest_V_1_ack_in == 1'b0) | (m_axis_video_V_id_V_1_ack_in == 1'b0) | (m_axis_video_V_last_V_1_ack_in == 1'b0) | (m_axis_video_V_user_V_1_ack_in == 1'b0) | (m_axis_video_V_strb_V_1_ack_in == 1'b0) | (m_axis_video_V_keep_V_1_ack_in == 1'b0) | (m_axis_video_V_data_V_1_ack_in == 1'b0)) & (tmp_1_fu_275_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        sel_tmp10_reg_737 <= sel_tmp10_fu_326_p2;
        sel_tmp11_reg_742 <= sel_tmp11_fu_331_p2;
        sel_tmp1_reg_707 <= sel_tmp1_fu_296_p2;
        sel_tmp2_reg_722 <= sel_tmp2_fu_311_p2;
        sel_tmp5_reg_712 <= sel_tmp5_fu_301_p2;
        sel_tmp6_reg_727 <= sel_tmp6_fu_316_p2;
        sel_tmp8_reg_717 <= sel_tmp8_fu_306_p2;
        sel_tmp9_reg_732 <= sel_tmp9_fu_321_p2;
        tmp_12_reg_747[31 : 2] <= tmp_12_fu_403_p3[31 : 2];
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        sel_tmp3_reg_693 <= sel_tmp3_fu_265_p2;
        sel_tmp4_reg_687 <= sel_tmp4_fu_259_p2;
        sel_tmp7_reg_681 <= sel_tmp7_fu_253_p2;
        sel_tmp_reg_675 <= sel_tmp_fu_247_p2;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) | ((tmp_13_fu_411_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3)))) begin
...
always @ (*) begin
    if (((tmp_13_fu_411_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if ((~((1'b1 == ap_block_state3_io) | ((tmp_13_fu_411_p2 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0))) & (tmp_13_fu_411_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if ((~((1'b1 == ap_block_state3_io) | ((tmp_13_fu_411_p2 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0))) & (tmp_13_fu_411_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    ap_block_state3 = ((tmp_13_fu_411_p2 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0));
end

always @ (*) begin
    ap_block_state3_io = ((tmp_13_fu_411_p2 == 1'd0) & (m_axis_video_V_data_V_1_ack_in == 1'b0));
end
...
assign hsize_in_op_op_fu_343_p2 = (32'd3 + hsize_in);

assign i_1_fu_646_p2 = (32'd4 + i_reg_236);

assign j_1_fu_280_p2 = (j_reg_225 + 31'd1);

assign j_cast_fu_271_p1 = j_reg_225;
...
assign m_axis_video_V_keep_V_1_data_out = 5'd0;
...
assign m_axis_video_V_strb_V_1_data_out = 5'd0;
...
assign p_Result_10_fu_577_p5 = {{{{p_Result_6_fu_567_p4}, {p_Result_3_fu_557_p4}}, {p_Result_9_fu_547_p4}}, {p_Result_7_fu_537_p4}};

assign p_Result_1_fu_475_p4 = {{s_axis_video_V_data_V_0_data_out[69:60]}};

assign p_Result_2_fu_485_p4 = {{s_axis_video_V_data_V_0_data_out[109:100]}};

assign p_Result_3_fu_557_p4 = {{s_axis_video_V_data_V_0_data_out[79:70]}};

assign p_Result_4_fu_495_p5 = {{{{p_Result_2_fu_485_p4}, {p_Result_1_fu_475_p4}}, {p_Result_s_7_fu_465_p4}}, {tmp_14_fu_461_p1}};

assign p_Result_5_fu_507_p4 = {{s_axis_video_V_data_V_0_data_out[119:110]}};

assign p_Result_6_fu_567_p4 = {{s_axis_video_V_data_V_0_data_out[99:90]}};

assign p_Result_7_fu_537_p4 = {{s_axis_video_V_data_V_0_data_out[19:10]}};

assign p_Result_8_fu_527_p4 = {{{p_Result_5_fu_507_p4}, {tmp_7_fu_517_p4}}, {tmp_14_fu_461_p1}};

assign p_Result_9_fu_547_p4 = {{s_axis_video_V_data_V_0_data_out[39:30]}};

assign p_Result_s_7_fu_465_p4 = {{s_axis_video_V_data_V_0_data_out[49:40]}};

assign p_Result_s_fu_453_p3 = {{tmp_5_fu_433_p4}, {tmp_6_fu_443_p4}};

assign p_lshr_fu_361_p4 = {{p_neg_fu_356_p2[31:2]}};

assign p_neg_fu_356_p2 = ($signed(32'd4294967293) - $signed(hsize_in));

assign p_neg_t_fu_371_p2 = (30'd0 - p_lshr_fu_361_p4);
...
assign sel_tmp10_fu_326_p2 = (tmp_3_fu_290_p2 & sel_tmp3_reg_693);

assign sel_tmp11_fu_331_p2 = (tmp_2_fu_286_p1 & sel_tmp3_reg_693);

assign sel_tmp1_fu_296_p2 = (tmp_3_fu_290_p2 & sel_tmp_reg_675);

assign sel_tmp2_fu_311_p2 = (tmp_2_fu_286_p1 & sel_tmp7_reg_681);

assign sel_tmp3_fu_265_p2 = ((pattern_V == 2'd3) ? 1'b1 : 1'b0);

assign sel_tmp4_fu_259_p2 = ((pattern_V == 2'd2) ? 1'b1 : 1'b0);

assign sel_tmp5_fu_301_p2 = (tmp_2_fu_286_p1 & sel_tmp_reg_675);

assign sel_tmp6_fu_316_p2 = (tmp_3_fu_290_p2 & sel_tmp4_reg_687);

assign sel_tmp7_fu_253_p2 = ((pattern_V == 2'd1) ? 1'b1 : 1'b0);

assign sel_tmp8_fu_306_p2 = (tmp_3_fu_290_p2 & sel_tmp7_reg_681);

assign sel_tmp9_fu_321_p2 = (tmp_2_fu_286_p1 & sel_tmp4_reg_687);

assign sel_tmp_fu_247_p2 = ((pattern_V == 2'd0) ? 1'b1 : 1'b0);

assign tmp_10_fu_387_p3 = ((tmp_8_fu_348_p3[0:0] === 1'b1) ? p_neg_t_fu_371_p2 : tmp_9_fu_377_p4);

assign tmp_11_fu_395_p3 = ((tmp_4_fu_336_p3[0:0] === 1'b1) ? 30'd0 : tmp_10_fu_387_p3);

assign tmp_12_fu_403_p3 = {{tmp_11_fu_395_p3}, {2'd0}};

assign tmp_13_fu_411_p2 = ((i_reg_236 == tmp_12_reg_747) ? 1'b1 : 1'b0);

assign tmp_14_fu_461_p1 = s_axis_video_V_data_V_0_data_out[9:0];

assign tmp_1_fu_275_p2 = (($signed(j_cast_fu_271_p1) < $signed(vsize_in)) ? 1'b1 : 1'b0);

assign tmp_2_fu_286_p1 = j_reg_225[0:0];

assign tmp_3_fu_290_p2 = (tmp_2_fu_286_p1 ^ 1'd1);

assign tmp_4_fu_336_p3 = hsize_in[32'd31];

assign tmp_5_fu_433_p4 = {{s_axis_video_V_data_V_0_data_out[99:80]}};

assign tmp_6_fu_443_p4 = {{s_axis_video_V_data_V_0_data_out[39:20]}};

assign tmp_7_fu_517_p4 = {{s_axis_video_V_data_V_0_data_out[69:50]}};

assign tmp_8_fu_348_p3 = hsize_in_op_op_fu_343_p2[32'd31];

assign tmp_9_fu_377_p4 = {{hsize_in_op_op_fu_343_p2[31:2]}};

assign video_o_data_V_11_fu_631_p3 = ((sel_tmp10_reg_737[0:0] === 1'b1) ? p_Result_4_fu_495_p5 : video_o_data_V_9_fu_624_p3);

assign video_o_data_V_4_fu_589_p3 = ((sel_tmp1_reg_707[0:0] === 1'b1) ? p_Result_s_fu_453_p3 : p_Val2_s_fu_156);

assign video_o_data_V_5_fu_596_p3 = ((sel_tmp5_reg_712[0:0] === 1'b1) ? p_Result_4_fu_495_p5 : video_o_data_V_4_fu_589_p3);

assign video_o_data_V_6_fu_603_p3 = ((sel_tmp8_reg_717[0:0] === 1'b1) ? p_Result_8_fu_527_p4 : video_o_data_V_5_fu_596_p3);

assign video_o_data_V_7_fu_610_p3 = ((sel_tmp2_reg_722[0:0] === 1'b1) ? p_Result_10_fu_577_p5 : video_o_data_V_6_fu_603_p3);

assign video_o_data_V_8_fu_617_p3 = ((sel_tmp6_reg_727[0:0] === 1'b1) ? p_Result_10_fu_577_p5 : video_o_data_V_7_fu_610_p3);

assign video_o_data_V_9_fu_624_p3 = ((sel_tmp9_reg_732[0:0] === 1'b1) ? p_Result_8_fu_527_p4 : video_o_data_V_8_fu_617_p3);

assign video_o_data_V_fu_638_p3 = ((sel_tmp11_reg_742[0:0] === 1'b1) ? p_Result_s_fu_453_p3 : video_o_data_V_11_fu_631_p3);

always @ (posedge ap_clk) begin
    tmp_12_reg_747[1:0] <= 2'b00;
end
