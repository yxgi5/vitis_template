...
generate
    ...
    if(MAXIMUM_DATA_WIDTH==8 && SAMPLES_PER_CLOCK==4)
        rgb2bayer_8bit_4spc rgb2bayer_inst(
            .ap_clk (ap_clk),
            .ap_rst_n (ap_rst_n),
            .s_axis_video_TDATA (s_axis_video_TDATA),
            .s_axis_video_TVALID (s_axis_video_TVALID),
    ...
    else if (MAXIMUM_DATA_WIDTH==10 && SAMPLES_PER_CLOCK==4)
        rgb2bayer_10bit_4spc rgb2bayer_inst(
            .ap_clk (ap_clk),
            .ap_rst_n (ap_rst_n),
            .s_axis_video_TDATA (s_axis_video_TDATA),
            .s_axis_video_TVALID (s_axis_video_TVALID),
    ...
    else if (MAXIMUM_DATA_WIDTH==12 && SAMPLES_PER_CLOCK==4)
        rgb2bayer_12bit_4spc rgb2bayer_inst(
            .ap_clk (ap_clk),
            .ap_rst_n (ap_rst_n),
            .s_axis_video_TDATA (s_axis_video_TDATA),
            .s_axis_video_TVALID (s_axis_video_TVALID),
    ...
    else if (MAXIMUM_DATA_WIDTH==16 && SAMPLES_PER_CLOCK==4)
        rgb2bayer_16bit_4spc rgb2bayer_inst(
            .ap_clk (ap_clk),
            .ap_rst_n (ap_rst_n),
            .s_axis_video_TDATA (s_axis_video_TDATA),
            .s_axis_video_TVALID (s_axis_video_TVALID),
